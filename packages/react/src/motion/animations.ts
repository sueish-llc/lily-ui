 ...
 * emitted by `@lily-ui/css`. Keeping the names here lets editors/agents complete
 * only valid animations and lets helpers (e.g. {@link useAnimate}, `<Presence>`)
 * accept a checked `AnimationName` instead of a free string.
 *
 * Must stay in sync with `packages/css/src/styles/utilities/_animations.scss`.
 */

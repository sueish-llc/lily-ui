...
// NOTE: unlike the React setup, `window.matchMedia` is intentionally NOT
// stubbed here — jsdom omits it, and the suite relies on that to verify the
// library guards browser-only globals (see BackTop.test.ts).
